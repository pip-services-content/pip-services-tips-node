# Deployment Guide <br/> Tips Microservice

Tips microservice can be used in different deployment scenarios.
...
The Tips microservice can also be used as a Seneca plugin.
...
var plugin = require('pip-services-tips-node').TipsSenecaPlugin;
...
or by using [TipsSenecaClient](https://github.com/pip-services/pip-clients-tips-node/NodeClientApiV1.md/#client_seneca)