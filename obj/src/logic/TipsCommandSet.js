...
class TipsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetTipsCommand() {
        return new pip_services3_commons_node_2.Command("get_tips", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetRandomTipCommand() {
        return new pip_services3_commons_node_2.Command("get_random_tip", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetTipByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_tip_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('tip_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let tipId = args.getAsNullableString("tip_id");
            this._logic.getTipById(correlationId, tipId, callback);
        });
    }
    makeCreateTipCommand() {
        return new pip_services3_commons_node_2.Command("create_tip", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateTipCommand() {
        return new pip_services3_commons_node_2.Command("update_tip", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('tip', new TipV1Schema_1.TipV1Schema()), (correlationId, args, callback) => {
            let tip = args.get("tip");
    ...
    makeDeleteTipByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_tip_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('tip_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let tipId = args.getAsNullableString("tip_id");
