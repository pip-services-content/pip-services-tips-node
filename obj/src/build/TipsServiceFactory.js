...
class TipsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
TipsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "factory", "default", "default", "1.0");
TipsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "persistence", "memory", "*", "1.0");
TipsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "persistence", "file", "*", "1.0");
TipsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "persistence", "mongodb", "*", "1.0");
TipsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "controller", "default", "*", "1.0");
TipsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "service", "seneca", "*", "1.0");
TipsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-tips", "service", "http", "*", "1.0");
